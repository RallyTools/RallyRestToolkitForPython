...
import sys
import importlib
importlib.reload(sys)  # Reload gets a sys module that has the setdefaultencoding before site.py deletes it
...
##
    ...
    def _unravel(self, thing):
        if isinstance(thing, dict) and thing.get('_type', None):
